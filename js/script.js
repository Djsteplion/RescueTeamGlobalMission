...
/***** Beginning Of  Script for GALLERY *****/

    // This is the target element
    const targetElement1 = document.querySelector('.galleryText');
...
/************************ Beginning of  Script for Do You Know Paragraphs ******************************/

    /** P1 **/
    // This is the target element
    const targetElementP1 = document.querySelector('.p1');
    ...
    observer2.observe(targetElementP1);
         ...
         /** P2 **/
        // This is the target element
        const targetElementP2 = document.querySelector('.p2');
...
/************************** End Of  Script for Do You Know Paragraphs *****************************************/



/**************************** Beginning Of SCRIPT FOR About Us Div  *****************************************/


    /* pastor img */
   // This is the target element
   const targetElementPast = document.querySelector('.pastor');
   ...
   observer4.observe(targetElementPast);
       ...
       /* About Us */
      // This is the target element
      const targetElement3 = document.querySelector('.pA');
      ...
      observer5.observe(targetElement3);
          ...
          /* Item 1 */
         // This is the target element
         const targetElementItem1 = document.querySelector('.item1');
         ...
         const observer6 = new IntersectionObserver((entries, observer) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    // add the css class that triggers the animation
                    targetElementItem1.classList.add('animate__animated', 'animate__rollIn');
         ...
         observer6.observe(targetElementItem1);
           ...
           /* Item 2 */
         // This is the target element
         const targetElementItem2 = document.querySelector('.item2');
         ...
         const observer7 = new IntersectionObserver((entries, observer) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    // add the css class that triggers the animation
                    targetElementItem2.classList.add('animate__animated', 'animate__rollIn');
